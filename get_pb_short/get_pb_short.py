...
period_list = ['987','610','377','233','144','89','55','34','21','13','','5','','','1']
i = 0
...
for index, row in df.iterrows():
    #print(row['trade_date'],row['pb1'],row['min1'])
...
for period in tmplist:
    ...
    pd.DataFrame(data=result_list,columns=['trade_date','dif_pb','close','本次金额','累计买入金额','累计卖出金额','股票剩余资产']).to_csv(stockcode+'_'+begindate+'_result.csv',encoding='utf_8_sig')
